...
const Button = ({ variant = "primary", colorScheme = "standardBG", hovered = false, children, }) => {
    return (jsx(StyledButton, { variant: variant, colorScheme: colorScheme, hovered: hovered, children: children }));
};
...
var Heading = withThemeProvider(Typography);

const H1 = ({ color, children }) => (jsx(Heading, { variant: "h1", color: color, children: children }));
const H2 = ({ color, children }) => (jsx(Heading, { variant: "h2", color: color, children: children }));
const H3 = ({ color, children }) => (jsx(Heading, { variant: "h3", color: color, children: children }));
const H4 = ({ color, children }) => (jsx(Heading, { variant: "h4", color: color, children: children }));
const H5 = ({ color, children }) => (jsx(Heading, { variant: "h5", color: color, children: children }));
